...
export type { Outcome, Constraint, Proposal, ProposalCheck, ConstraintViolation, NarrowingResult, NarrowingConfig, ConvergenceState, ScoreDirection, FailureKind, DomainAdapter, SignaturePattern, JournalEntry, } from './types.js';
