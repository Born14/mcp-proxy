...
export class ConvergenceTracker {
    ...
    update(outcome, constraints) {
        ...
        const totalStrategies = Math.max(this.state.bannedStrategyCount + 1, // at least 1 unbanned
        active.length + 1);
        this.state.searchSpaceRemaining = Math.max(0, 1 - (this.state.bannedStrategyCount / totalStrategies));
        // Score tracking
